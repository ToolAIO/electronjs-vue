...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$1]]);
/*!
  * vue-router v4.4.5
...
const _imports_0$1 = "" + new URL("../favicon.ico", import.meta.url).href;
const _hoisted_1$3 = { class: "h-screen w-screen flex" };
const _hoisted_2$2 = { class: "md:flex flex-col w-64 h-full overflow-hidden text-gray-400 bg-[#0c070c] border-r border-[#424244]" };
const _hoisted_3$1 = { class: "mt-2 p-5" };
const _hoisted_4$1 = { class: "text-sm ml-2" };
const _hoisted_5 = { class: "w-full h-full md:col-span-3 sm:overflow-auto relative z-0 text-white p-4" };
const _sfc_main$4 = {
  __name: "Sidebar",
  setup(__props) {
        ...
        createBaseVNode("div", _hoisted_2$2, [
          createVNode(_component_router_link, {
            ...
            default: withCtx(() => _cache[0] || (_cache[0] = [
              ...
              createBaseVNode("span", { class: "ml-2 text-base font-bold" }, "AIO Download", -1)
            ])),
            _: 1
          }),
          createBaseVNode("div", _hoisted_3$1, [
            (openBlock(), createElementBlock(Fragment, null, renderList(tabs, (tab, index2) => {
              return createVNode(_component_router_link, {
                key: index2,
                to: tab.route,
                class: normalizeClass(["flex items-center w-full sidebar-button hover:text-white p-2 rounded-lg transition duration-150 ease-out cursor-pointer", { "bg-[#615876] bg-opacity-20 text-white": isTabActive(tab.route) }]),
                onClick: ($event) => changeTab(index2)
              }, {
                default: withCtx(() => [
                  createBaseVNode("i", {
                    class: normalizeClass([tab.icon, "text-lg"])
                  }, null, 2),
                  createBaseVNode("p", _hoisted_4$1, toDisplayString(tab.label), 1)
                ]),
                _: 2
...
const _hoisted_1$2 = { class: "w-full flex justify-between" };
const _hoisted_2$1 = { class: "flex items-center space-x-4" };
const _hoisted_3 = { class: "bg-violet-800 rounded flex items-center justify-center w-11 h-11" };
const _hoisted_4 = { class: "font-bold text-2xl" };
const _sfc_main$3 = {
  __name: "TitleBase",
  props: {
    title: {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("i", {
              class: normalizeClass(`${__props.boxIcon} text-3xl text-violet-500`)
            }, null, 2)
          ]),
          createBaseVNode("h1", _hoisted_4, toDisplayString(__props.title), 1)
        ])
      ]);
    };
  }
  ...
  setup(__props) {
    ...
    const sendMessage = () => {
      if (message.value.trim()) {
        window.electronAPI.messageToElectron(message.value);
        l.info("Message was successfully sent!", {
          theme: "dark",
          autoClose: 2e3,
          position: l.POSITION.TOP_RIGHT
        });
      } else {
        l.warn("Please enter a message before sending.", {
          theme: "dark",
          autoClose: 2e3,
          position: l.POSITION.TOP_RIGHT
        });
      ...
      return openBlock(), createBlock(_sfc_main$4, null, {
        default: withCtx(() => [
          ...
          createBaseVNode("a", {
            ...
            createBaseVNode("i", { class: "bx bx-check mr-2 mt-10" }, null, -1),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$4, null, {
        default: withCtx(() => [
          createVNode(_sfc_main$3, {
            title: "About",
            boxIcon: "bx bxs-info-circle"
          }),
          _cache[0] || (_cache[0] = createBaseVNode("h1", null, "This is the about page!", -1))
        ]),
        _: 1
      });
    };
...
const _imports_0 = "" + new URL("bongo_moth-b8248d82.gif", import.meta.url).href;
const _sfc_main = {};
const _hoisted_1 = { class: "text-center mt-12 flex flex-col justify-center items-center" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1, _cache[0] || (_cache[0] = [
    createBaseVNode("h1", { class: "text-6xl font-bold text-red-400" }, "404", -1),
    createBaseVNode("p", { class: "text-xl text-gray-400" }, "Not Found", -1),
    createBaseVNode("img", {
      class: "my-12",
      src: _imports_0,
      alt: "Bongo moth"
...
const Error$2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
const Error$1 = [
  {
    path: "/:catchAll(.*)",
    name: "error",
...
const router = createRouter({
  ...
  // Must use Hash mode for Electron
  routes: [
    ...Home,
    ...About,
    ...Error$1
